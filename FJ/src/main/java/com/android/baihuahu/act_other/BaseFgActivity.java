...
import com.android.baihuahu.base.service.ConnectionChangeReceiver;
import com.android.baihuahu.util.StatusBarUtil;
...
public class BaseFgActivity extends FragmentActivity {
    ...
    protected void initTitleBackBt(int id) {
        initTitleBackBt(getString(id));
    }
