...
import com.android.baihuahu.bean.User;
import com.android.baihuahu.core.utils.AuthsConstant;
import com.android.baihuahu.core.utils.Constant;
import com.android.baihuahu.core.utils.KeyConst;
import com.android.baihuahu.core.utils.Log;
import com.android.baihuahu.core.utils.SPUtils;
...
public class App extends Application {
    ...
    public static String employeeName = "港的的";
    ...
    public static String projecId;
    public static int userId = 0;  //设备id
    ...
    public static String amTime;
    public static String pmTime;
    public static String loginType;
    public static String[] authsArr;
    public static int employeeId = 0;
    public static ArrayList list1 = new ArrayList();
    public static ArrayList<List<String>> list2 = new ArrayList();
    public static ArrayList<List<List<String>>> list3 = new ArrayList();
    public static List<DeptInfo> billIdTreeList;
